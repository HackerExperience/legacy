...
//}
//
//$sql_array['WHERE'] .= ' AND (f.forum_clan = 0 OR f.forum_clan = '.$clanID.')';
	...
	if (!isset($user_cache[$poster_id]))
	{
		if ($poster_id == ANONYMOUS)
		{
			$user_cache[$poster_id] = array(
				...
				'online'			=> false,
				'avatar'			=> ($user->optionget('viewavatars')) ? get_user_avatar($row['username']) : '',
				'rank_title'		=> '',
				'rank_image'		=> '',
				'rank_image_src'	=> '',
				'sig'				=> '',
		...
		else
		{
			...
			$user_cache[$poster_id] = array(
				...
				'avatar'		=> ($user->optionget('viewavatars')) ? get_user_avatar($row['username'], $row['user_avatar_type'], $row['user_avatar_width'], $row['user_avatar_height']) : '',
				'age'			=> '',

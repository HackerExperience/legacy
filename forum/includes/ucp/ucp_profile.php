		...
		switch ($mode)
		{
			...
			case 'signature':
                            ...
                            if(!isset($_SESSION['premium'])){
                                exit("Please, logout and login again.");
                            }
			...
			case 'avatar':
				...
				$template->assign_vars(array(
					'ERROR'			=> (sizeof($error)) ? implode('<br />', $error) : '',
					'AVATAR'		=> get_user_avatar($user->data['username'], $user->data['user_avatar_type'], $user->data['user_avatar_width'], $user->data['user_avatar_height'], 'USER_AVATAR', true),

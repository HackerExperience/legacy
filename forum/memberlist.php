...
//				$s_forum_select = '<option value="">' . $user->lang['FORUM_UNDISCLOSED'] . '</option>';
	...
	case 'viewprofile':
		...
		$poster_avatar = get_user_avatar($member['username'], $member['user_avatar_type'], $member['user_avatar_width'], $member['user_avatar_height']);
...
function show_profile($data, $user_notes_enabled = false, $warn_user_enabled = false)
{
	...
	return array(
		...
		'AVATAR_IMG'		=> get_user_avatar($data['username'], $data['user_avatar_type'], $data['user_avatar_width'], $data['user_avatar_height']),

	...
	$.sceditor.defaultOptions = {
		...
		emoticons: {
			dropdown: {
				...
				':angel:': '../images/emoticons/angel.png',
				':angry:': '../images/emoticons/angry.png',
				'8-)': '../images/emoticons/cool.png',
				":'(": '../images/emoticons/cwy.png',
				':ermm:': '../images/emoticons/ermm.png',
				':D': '../images/emoticons/grin.png',
				'<3': '../images/emoticons/heart.png',
				':(': '../images/emoticons/sad.png',
				':O': '../images/emoticons/shocked.png',
				':P': '../images/emoticons/tongue.png',
				';)': '../images/emoticons/wink.png'
			},
			more: {
				':alien:': '../images/emoticons/alien.png',
				':blink:': '../images/emoticons/blink.png',
				':blush:': '../images/emoticons/blush.png',
				':cheerful:': '../images/emoticons/cheerful.png',
				':devil:': '../images/emoticons/devil.png',
				':dizzy:': '../images/emoticons/dizzy.png',
				':getlost:': '../images/emoticons/getlost.png',
				':happy:': '../images/emoticons/happy.png',
				':kissing:': '../images/emoticons/kissing.png',
				':ninja:': '../images/emoticons/ninja.png',
				':pinch:': '../images/emoticons/pinch.png',
				':pouty:': '../images/emoticons/pouty.png',
				':sick:': '../images/emoticons/sick.png',
				':sideways:': '../images/emoticons/sideways.png',
				':silly:': '../images/emoticons/silly.png',
				':sleeping:': '../images/emoticons/sleeping.png',
				':unsure:': '../images/emoticons/unsure.png',
				':woot:': '../images/emoticons/w00t.png',
				':wassat:': '../images/emoticons/wassat.png',
				':whistling:': '../images/emoticons/whistling.png',
				':love:': '../images/emoticons/wub.png'
			},
			hidden: {
...
//GAME FUNCTIONS RELATED TO WYSIWYG \/

function toggleEditor(t){

	//console.log(t)

	if(!t.hasClass('hide-editor')){
	    ...
	    var text = $('textarea#wysiwyg').val(); //TODO: tá bugado. usar on keyup ou coisa parecida

	    $('#wysiwyg').parent().html('<textarea id="wysiwyg" name="text">'+$('#wysiwyg').val()+'</textarea>')
	    $('#wysiwyg').focus();
...
function wysiwyg(opts){
    ...
    var id = '#wysiwyg';
    var toolbar = 'bold,italic,underline|emoticon|left,center,right,justify|size,color|bulletlist,orderedlist|removeformat,maximize'
    var height = 150;
    var width = "82%";
    var AE = true;
    ...
    switch(opts.type){
        case 'new':
        toolbar = "bold,italic,underline|emoticon|left,center,right,justify|size,color|bulletlist,orderedlist|removeformat,maximize";
        height = 150;
        break;
        case 'reply':
        toolbar = "bold,italic,underline|emoticon|left,center,right,justify|size,color|bulletlist,orderedlist|removeformat,maximize";
        ...
        break;
        case 'clan':
        toolbar = "bold,italic,underline|emoticon|left,center,right,justify|size,color|bulletlist,orderedlist|horizontalrule,link,unlink|removeformat,maximize";
        height = 350;
        break;
        case 'text':
        width = "90%"
    ...
    if(opts.loadcss){
        $('<link rel="stylesheet" type="text/css" href="css/wysiwyg.css" >').appendTo("head");
    }
...
function openEditor(type){
    ...
    switch(type){
        case 'new':
        	wysiwyg({type:'new',loadcss:false,autofocus:false});
        	break;
        case 'new-focus':
        	wysiwyg({type:'new',loadcss:false,autofocus:true});
        	break;
        case 'reply':
        	wysiwyg({type:'reply',loadcss:true,autofocus:true})
        	break;
        case 'clan':
        	wysiwyg({type:'clan',loadcss:true,autofocus:true})
        	break;
        case 'text':
        	wysiwyg({type:'text',loadcss:true,autofocus:true})
        	break;
    }
